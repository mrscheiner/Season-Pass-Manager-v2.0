...
>>>>>>> 16dba40aa7b887e26e4a9827e6997c52804727ca
  ...
  useEffect(() => {
    ...
    // Only auto-fetch if games array is completely missing or empty AND we haven't attempted yet
    const hasGames = activeSeasonPass.games && activeSeasonPass.games.length > 0;
    if (hasGames) {
      return;
    }
...
>>>>>>> 16dba40aa7b887e26e4a9827e6997c52804727ca
  ...
  const clearAllData = useCallback(async () => {
    ...
    setActiveSeasonPassId(null);
    setNeedsSetup(true);
    await AsyncStorage.multiRemove([SEASON_PASSES_KEY, ACTIVE_PASS_KEY]);
...
>>>>>>> 16dba40aa7b887e26e4a9827e6997c52804727ca
  ...
  setNeedsSetup(normalized.length === 0);
      ...
      await AsyncStorage.setItem(SEASON_PASSES_KEY, JSON.stringify(data.seasonPasses));
